            ...
            <div class="post-column">
                ...
                <div class="post-column__stats">
                    <span class="stat-item">
                        ...
                        <img src="/src/assets/images/iconHeart.svg" alt="heart" />
                        {{ post.metricsToday.likes }}
                    </span>
                    <span class="stat-item">

                        <img src="/src/assets/images/iconMessage.svg" alt="message" />
        ...
        <div class="post-grid-card__content">
            ...
            <div class="grid-meta-row">
                <div class="grid-meta-row__stats">
                    <span> <img src="/src/assets/images/iconHeart.svg" alt="heart" /> {{ post.metricsToday.likes
                        }}</span>
                    <span> <img src="/src/assets/images/iconMessage.svg" alt="message" /> {{
                        post.metricsToday.comments
                        }}</span>
                </div>
                <div class="grid-meta-row__stats">
                    <span> <img src="/src/assets/images/iconHeart.svg" alt="heart" /> {{ post.metricsHistory.likes
                        }} </span>
                    <span> <img src="/src/assets/images/iconMessage.svg" alt="message" /> {{
                        post.metricsHistory.comments
                        }}</span>
